    ...
    <footer style={{ background: 'var(--dark)', color: '#fff', direction: 'rtl', marginTop: 'auto', borderTop: '2px solid var(--primary)' }}>
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '48px 24px 24px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 32, marginBottom: 40 }}>
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 14 }}>
              ...
              <span style={{ fontSize: 17, fontWeight: 900 }}>کتاب‌خانه</span>
            </div>
          ...
          <div>
            ...
            {[['/', 'صفحه اصلی'], ['/blog', 'بلاگ'], ['/login', 'ورود به حساب']].map(([to, label]) => (
          ...
          <div>
            <h4 style={{ fontSize: 12, fontWeight: 700, marginBottom: 14, color: 'rgba(255,255,255,0.5)', textTransform: 'uppercase', letterSpacing: '1px' }}>تماس</h4>
            <p style={{ fontSize: 13, color: 'rgba(255,255,255,0.45)', lineHeight: 2 }}>
              پشتیبانی ۲۴/۷<br />
              support@book.ir
            </p>
          </div>
        ...
        <div style={{ borderTop: '1px solid rgba(255,255,255,0.08)', paddingTop: 20, display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 8 }}>
          <p style={{ fontSize: 11, color: 'rgba(255,255,255,0.25)' }}>© ۱۴۰۳ کتاب‌خانه</p>
